...
<body>
    ...
    $sql = "SELECT p.id, p.name, p.photo, p.price, p.description, p.manufacture_id, p.unit, p.date_end, p.date_start, p.discount, p.number, SUM(op.quantity) AS total_quantity_sold
            FROM products p
