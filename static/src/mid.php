                        ...
                        <div class="category">
                            ...
                            <ul class="category__list">
                                <?php foreach ($result_catelogy as $each) : ?>
                                    <li class="category__list-item--active category__list-item">
                    ...
                    <div class="col l-10 m-12 c-12">
                        ...
                        <ul class="pagination">
                            ...
                            <li class="pagination-item">
                                <a class="pagination-item-link" href="?page=<?php echo ($current_page > 1) ? ($current_page - 1) : 1 ?>&search=<?php echo $search ?>">
                            ...
                            <?php for ($i = 1; $i <= $total_pages; $i++) { ?>
                                <li class="pagination-item <?php echo ($i == $current_page) ? 'pagination-item-link--active' : '' ?>">
                                    <a class="pagination-item-link" href="?page=<?php echo $i ?>&search=<?php echo $search ?>"><?php echo $i ?></a>
                                </li>
                            <?php } ?>

                            <!-- Next Page Link -->
                            <li class="pagination-item">
                                <a class="pagination-item-link" href="?page=<?php echo ($current_page < $total_pages) ? ($current_page + 1) : $total_pages ?>&search=<?php echo $search ?>">
